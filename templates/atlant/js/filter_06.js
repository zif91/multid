...
$(function() {
	...
	var Filter = {
		...
		load: function(data) {
    console.log('Filter.load:', data); // add this line to log the data variable
    $.ajax({
        ...
        success: function(data) {
            console.log('Filter.load: ajax success'); // add this line to log success
            data = $(data);
            ...
            console.log('Filter.load: dataFilter', dataFilter); // add this line to log dataFilter
        ...
        error: function(jqXHR, textStatus, errorThrown) {
            console.log('Filter.load: ajax error', textStatus, errorThrown); // add this line to log errors
        }
    });
